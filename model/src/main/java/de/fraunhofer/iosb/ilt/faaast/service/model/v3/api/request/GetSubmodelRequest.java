...
import de.fraunhofer.iosb.ilt.faaast.service.model.v3.api.response.GetSubmodelResponse;
 ...
 * Chapter 4.3.2
 */
public class GetSubmodelRequest extends BaseRequest<GetSubmodelResponse> {
    ...
    public static abstract class AbstractBuilder<T extends GetSubmodelRequest, B extends AbstractBuilder<T, B>> extends ExtendableBuilder<T, B> {
