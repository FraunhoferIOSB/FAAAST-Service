...
import de.fraunhofer.iosb.ilt.faaast.service.model.v3.api.response.GetAllConceptDescriptionsByIdShortResponse;
 ...
 * Chapter 6.4.4
 */
public class GetAllConceptDescriptionsByIdShortRequest extends BaseRequest<GetAllConceptDescriptionsByIdShortResponse> {
    private OutputModifier outputModifier;
    private String idShort;

    public GetAllConceptDescriptionsByIdShortRequest() {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        GetAllConceptDescriptionsByIdShortRequest that = (GetAllConceptDescriptionsByIdShortRequest) o;
    ...
    public static abstract class AbstractBuilder<T extends GetAllConceptDescriptionsByIdShortRequest, B extends AbstractBuilder<T, B>> extends ExtendableBuilder<T, B> {
    ...
    public static class Builder extends AbstractBuilder<GetAllConceptDescriptionsByIdShortRequest, Builder> {
        ...
        @Override
        protected GetAllConceptDescriptionsByIdShortRequest newBuildingInstance() {
