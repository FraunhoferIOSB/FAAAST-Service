...
/**
 * Request class for QueryAssetAdministrationShells requests.
 */
public class QueryAssetAdministrationShellsRequest extends AbstractRequestWithModifierAndPaging<QueryAssetAdministrationShellsResponse> {

    private Query query;

    protected QueryAssetAdministrationShellsRequest() {
        super(READ, AAS);
    }
    ...
    public boolean equals(Object o) {
        ...
        QueryAssetAdministrationShellsRequest that = (QueryAssetAdministrationShellsRequest) o;
    ...
    public abstract static class AbstractBuilder<T extends QueryAssetAdministrationShellsRequest, B extends AbstractBuilder<T, B>>
    ...
    public static class Builder extends AbstractBuilder<QueryAssetAdministrationShellsRequest, Builder> {
        ...
        @Override
        protected QueryAssetAdministrationShellsRequest newBuildingInstance() {
            return new QueryAssetAdministrationShellsRequest();
        }
    }
}
