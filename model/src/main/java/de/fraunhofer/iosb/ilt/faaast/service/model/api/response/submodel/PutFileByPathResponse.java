...
/**
 * Response class for PutFileByPath requests.
 */
public class PutFileByPathResponse extends AbstractResponse {
    ...
    public static class Builder extends AbstractBuilder<PutFileByPathResponse, Builder> {
        ...
        @Override
        protected PutFileByPathResponse newBuildingInstance() {
