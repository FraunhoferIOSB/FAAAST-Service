...
public class ReadDppByProductIdRequest extends AbstractDppRequest<ReadDPPByProductIdResponse> {
    ...
    public static class Builder extends AbstractBuilder<ReadDppByProductIdRequest, ReadDppByProductIdRequest.Builder> {

        @Override
        protected ReadDppByProductIdRequest.Builder getSelf() {
            return this;
        }
