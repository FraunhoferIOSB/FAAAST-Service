...
/**
 * Response class for GetSelfDescription requests.
 */
public class GetSelfDescriptionResponse extends AbstractResponseWithPayload<ServiceDescription> {
    ...
    public static class Builder extends AbstractBuilder<ServiceDescription, GetSelfDescriptionResponse, Builder> {
        ...
        @Override
        protected GetSelfDescriptionResponse newBuildingInstance() {
