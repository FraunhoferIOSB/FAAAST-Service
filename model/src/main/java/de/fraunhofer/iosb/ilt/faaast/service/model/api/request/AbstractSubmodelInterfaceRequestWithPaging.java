...
/**
 * Base class for requests of the Submodel API interface that suppport
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.modifier.OutputModifier} and paging.
 *
 * @param <T> actual type of the request
 */
public abstract class AbstractSubmodelInterfaceRequestWithPaging<T extends Response> extends AbstractSubmodelInterfaceRequest<T> {
    ...
    public abstract static class AbstractBuilder<T extends AbstractSubmodelInterfaceRequestWithPaging, B extends AbstractBuilder<T, B>>
