 ...
 * 
 */
public abstract class AbstractBaseOperationResultBuilder<T extends BaseOperationResult, B extends AbstractBaseOperationResultBuilder<T, B>>
        extends BaseOperationResultBuilder<T, B> {
