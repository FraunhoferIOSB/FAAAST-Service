...
/**
 * Request class for QueryConceptDescriptions requests.
 */
public class QueryConceptDescriptionsRequest extends AbstractRequestWithModifierAndPaging<QueryConceptDescriptionsResponse> {
    ...
    public boolean equals(Object o) {
        ...
        QueryConceptDescriptionsRequest that = (QueryConceptDescriptionsRequest) o;
    ...
    public static class Builder extends AbstractBuilder<QueryConceptDescriptionsRequest, Builder> {
        ...
        @Override
        protected QueryConceptDescriptionsRequest newBuildingInstance() {
            return new QueryConceptDescriptionsRequest();
        }
    }
}
