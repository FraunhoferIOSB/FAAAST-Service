...
public class ReadDPPIdsByProductIdsResponse extends AbstractPagedResponse<String> {
    ...
    public static class Builder extends AbstractBuilder<String, ReadDPPIdsByProductIdsResponse, Builder> {
        ...
        @Override
        protected ReadDPPIdsByProductIdsResponse newBuildingInstance() {
            return new ReadDPPIdsByProductIdsResponse();
        }
    }
}
