...
import de.fraunhofer.iosb.ilt.faaast.service.model.v3.api.response.GetAssetInformationResponse;
 ...
 * Chapter 4.2.7
 */
public class GetAssetInformationRequest extends BaseRequest<GetAssetInformationResponse> {
    ...
    public static class Builder extends AbstractBuilder<GetAssetInformationRequest, Builder> {
        ...
        @Override
        protected GetAssetInformationRequest newBuildingInstance() {
            return new GetAssetInformationRequest();
        }
    }
}
