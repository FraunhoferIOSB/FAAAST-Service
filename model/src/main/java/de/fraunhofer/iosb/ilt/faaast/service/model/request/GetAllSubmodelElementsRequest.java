 ...
 * Chapter 4.3.3
 */
public class GetAllSubmodelElementsRequest extends RequestWithModifier<GetAllSubmodelElementsResponse> {
    ...
    public static abstract class AbstractBuilder<T extends GetAllSubmodelElementsRequest, B extends AbstractBuilder<T, B>> extends RequestWithModifier.AbstractBuilder<T, B> {
