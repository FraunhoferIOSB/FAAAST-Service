...
import de.fraunhofer.iosb.ilt.faaast.service.model.v3.api.response.GetAllAASXPackageIdsResponse;
...
public class GetAllAASXPackageIdsRequest extends BaseRequest<GetAllAASXPackageIdsResponse> {
    ...
    public static abstract class AbstractBuilder<T extends GetAllAASXPackageIdsRequest, B extends AbstractBuilder<T, B>> extends ExtendableBuilder<T, B> {
