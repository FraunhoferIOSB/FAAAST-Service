 ...
 * Chapter 4.2.2
 */
public class GetAssetAdministrationShellRequest extends BaseRequest<GetAssetAdministrationShellResponse> {
    ...
    public static abstract class AbstractBuilder<T extends GetAssetAdministrationShellRequest, B extends AbstractBuilder<T, B>> extends ExtendableBuilder<T, B> {
