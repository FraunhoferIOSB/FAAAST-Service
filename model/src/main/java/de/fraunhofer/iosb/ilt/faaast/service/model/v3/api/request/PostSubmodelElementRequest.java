...
import de.fraunhofer.iosb.ilt.faaast.service.model.v3.api.response.PostSubmodelElementResponse;
...
public class PostSubmodelElementRequest extends BaseRequest<PostSubmodelElementResponse> {
    ...
    public static abstract class AbstractBuilder<T extends PostSubmodelElementRequest, B extends AbstractBuilder<T, B>> extends ExtendableBuilder<T, B> {
