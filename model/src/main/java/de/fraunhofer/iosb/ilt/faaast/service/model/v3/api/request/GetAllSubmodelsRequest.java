...
import de.fraunhofer.iosb.ilt.faaast.service.model.v3.api.response.GetAllSubmodelsResponse;
 ...
 * Chapter 6.3.2
 */
public class GetAllSubmodelsRequest extends BaseRequest<GetAllSubmodelsResponse> {
    ...
    public static abstract class AbstractBuilder<T extends GetAllSubmodelsRequest, B extends AbstractBuilder<T, B>> extends ExtendableBuilder<T, B> {
