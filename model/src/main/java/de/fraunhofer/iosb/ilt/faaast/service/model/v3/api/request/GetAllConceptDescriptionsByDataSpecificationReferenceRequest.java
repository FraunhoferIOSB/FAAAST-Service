 ...
 * Chapter 6.4.6
 */
public class GetAllConceptDescriptionsByDataSpecificationReferenceRequest extends BaseRequest<GetAllConceptDescriptionsByDataSpecificationReferenceResponse> {
    private OutputModifier outputModifier;
    private Reference dataSpecificationReference;

    public GetAllConceptDescriptionsByDataSpecificationReferenceRequest() {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(outputModifier, dataSpecificationReference);
    }
