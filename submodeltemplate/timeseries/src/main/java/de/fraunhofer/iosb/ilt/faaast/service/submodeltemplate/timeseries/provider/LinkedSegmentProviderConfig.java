...
/**
 * Abstract base configuration for any implementation of {@link LinkedSegmentProvider}.
 *
...
public abstract class LinkedSegmentProviderConfig<T extends LinkedSegmentProvider> extends SegmentProviderConfig<T> {
    ...
    protected abstract static class AbstractBuilder<T extends LinkedSegmentProviderConfig, B extends AbstractBuilder<T, B>>
