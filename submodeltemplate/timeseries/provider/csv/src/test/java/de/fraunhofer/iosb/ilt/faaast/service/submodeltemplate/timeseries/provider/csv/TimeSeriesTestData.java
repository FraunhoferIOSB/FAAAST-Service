...
public class TimeSeriesTestData {
    ...
    public static final Record RECORD_00 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-01T00:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-01T01:00:00Z"))
    ...
    public static final Record RECORD_01 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-01T01:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-01T02:00:00Z"))
    ...
    public static final Record RECORD_02 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-01T02:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-01T03:00:00Z"))
            .variable(FIELD_1, TypedValueFactory.createSafe(Datatype.INT, "2"))
            .variable(FIELD_2, TypedValueFactory.createSafe(Datatype.DOUBLE, "0.1"))
            .build();

    public static final Record RECORD_03 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-01T03:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-01T04:00:00Z"))
    ...
    public static final Record RECORD_04 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-01T04:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-01T05:00:00Z"))
            .variable(FIELD_1, TypedValueFactory.createSafe(Datatype.INT, "4"))
            .variable(FIELD_2, TypedValueFactory.createSafe(Datatype.DOUBLE, "0.1"))
            .build();

    public static final Record RECORD_05 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-02T01:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-02T02:00:00Z"))
    ...
    public static final Record RECORD_06 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-02T02:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-02T03:00:00Z"))
            .variable(FIELD_1, TypedValueFactory.createSafe(Datatype.INT, "6"))
            .variable(FIELD_2, TypedValueFactory.createSafe(Datatype.DOUBLE, "0.1"))
            .build();

    public static final Record RECORD_07 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-02T03:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-02T04:00:00Z"))
    ...
    public static final Record RECORD_08 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-03T01:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-03T02:00:00Z"))
    ...
    public static final Record RECORD_09 = Record.builder()
            .time("Time00", ZonedDateTime.parse("2022-02-03T02:00:00Z"))
            .time("Time01", ZonedDateTime.parse("2022-02-03T03:00:00Z"))
