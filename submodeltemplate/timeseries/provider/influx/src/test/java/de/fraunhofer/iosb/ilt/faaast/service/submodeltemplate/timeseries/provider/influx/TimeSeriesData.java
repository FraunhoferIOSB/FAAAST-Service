...
public class TimeSeriesData {
    ...
    public static final Metadata METADATA = Metadata.builder()
            .recordMetadataTimeOrVariable("time", time00Builder("2022-01-01T00:00:00Z"))
    ...
    public static final Record RECORD_00 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-01T00:00:00Z"))
    ...
    public static final Record RECORD_01 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-01T01:00:00Z"))
    ...
    public static final Record RECORD_02 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-01T02:00:00Z"))
    ...
    public static final Record RECORD_03 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-01T03:00:00Z"))
    ...
    public static final Record RECORD_04 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-01T04:00:00Z"))
    ...
    public static final Record RECORD_05 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-01T05:00:00Z"))
    ...
    public static final Record RECORD_06 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-02T06:00:00Z"))
    ...
    public static final Record RECORD_07 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-02T07:00:00Z"))
    ...
    public static final Record RECORD_08 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-03T08:00:00Z"))
    ...
    public static final Record RECORD_09 = Record.builder()
            .timeOrVariable("time", time00Builder("2022-01-03T09:00:00Z"))
