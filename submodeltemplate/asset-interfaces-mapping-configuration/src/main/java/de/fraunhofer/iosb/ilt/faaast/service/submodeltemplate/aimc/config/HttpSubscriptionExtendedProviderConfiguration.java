...
public class HttpSubscriptionExtendedProviderConfiguration extends ExtendedConfiguration {

    private long interval;

    public HttpSubscriptionExtendedProviderConfiguration() {
        super(Protocol.HTTP, ProviderType.SUBSCRIPTION);
    }
