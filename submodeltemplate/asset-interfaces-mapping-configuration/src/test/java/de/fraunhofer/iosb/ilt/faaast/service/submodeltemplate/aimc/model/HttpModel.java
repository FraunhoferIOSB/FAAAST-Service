...
public class HttpModel {
    ...
    public static final String OPER_DATA_HTTP_P2 = "L3";
    ...
    public static final String P2_URL = "/L3";
    ...
    private static final String PROPERTY_2 = "Voltage_L3";
                                ...
                                .value(new DefaultRelationshipElement.Builder()
                                        .semanticId(new DefaultReference.Builder()
                                                ...
                                                .keys(new DefaultKey.Builder()
                                                        ...
                                                        .build())
                                                .build())
                                        .first(ReferenceBuilder.forSubmodel(SUBMODEL_AID_ID, INTERFACE_HTTP, Constants.INTERACTION_METADATA, Constants.PROPERTIES, PROPERTY_2))
                                        .second(ReferenceBuilder.forSubmodel(SUBMODEL_OPER_DATA_ID, OPER_DATA_HTTP, OPER_DATA_HTTP_P2))
                                        .build())
                                .build())
                        .build())
                .build();
