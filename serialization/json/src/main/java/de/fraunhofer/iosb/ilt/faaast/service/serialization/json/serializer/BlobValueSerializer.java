...
public class BlobValueSerializer extends OutputModifierAwareSerializer<BlobValue> {
    ...
    @Override
    public void serialize(BlobValue value, JsonGenerator generator, SerializerProvider provider, OutputModifier modifier) throws IOException, JsonProcessingException {
        if (value != null) {
            generator.writeStartObject();
            generator.writeStringField("mimeType", value.getMimeType());
            if (modifier.getExtend() == Extend.WithBLOBValue) {
