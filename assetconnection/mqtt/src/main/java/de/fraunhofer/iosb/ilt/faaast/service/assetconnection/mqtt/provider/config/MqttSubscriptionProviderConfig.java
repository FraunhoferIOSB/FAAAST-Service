...
/**
 * Config file for MQTT-based {@link de.fraunhofer.iosb.ilt.faaast.service.assetconnection.AssetSubscriptionProvider}.
 */
public class MqttSubscriptionProviderConfig extends AbstractMultiFormatSubscriptionProviderConfig {
    ...
    public boolean sameAs(AssetProviderConfig other) {
        ...
        MqttSubscriptionProviderConfig that = (MqttSubscriptionProviderConfig) other;
    ...
    public abstract static class AbstractBuilder<T extends MqttSubscriptionProviderConfig, B extends AbstractBuilder<T, B>>
