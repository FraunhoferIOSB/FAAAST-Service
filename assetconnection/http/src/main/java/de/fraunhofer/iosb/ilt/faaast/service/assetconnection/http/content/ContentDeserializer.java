...
/**
 * Interface for deserializing content received via HTTP.
 */
public interface ContentDeserializer {

    /**
     * Parses a raw value received via HTTP to the corresponding
     * {@link de.fraunhofer.iosb.ilt.faaast.service.model.value.DataElementValue}.
     *
     * @param raw the raw message received via HTTP
