...
public class AASIriConceptDescriptionTypeNode extends AASIriConceptDescriptionTypeNodeBase {
    protected AASIriConceptDescriptionTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId,
