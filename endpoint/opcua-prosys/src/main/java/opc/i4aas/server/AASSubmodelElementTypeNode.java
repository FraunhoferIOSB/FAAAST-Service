...
public class AASSubmodelElementTypeNode extends AASSubmodelElementTypeNodeBase {
    protected AASSubmodelElementTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId,
