...
public class AASAnnotatedRelationshipElementTypeNode extends AASAnnotatedRelationshipElementTypeNodeBase {
    protected AASAnnotatedRelationshipElementTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId,
