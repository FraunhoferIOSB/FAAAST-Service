...
public class AASAssetTypeNode extends AASAssetTypeNodeBase {
    protected AASAssetTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName,
