...
public class AASBlobTypeNode extends AASBlobTypeNodeBase {
    protected AASBlobTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName,
