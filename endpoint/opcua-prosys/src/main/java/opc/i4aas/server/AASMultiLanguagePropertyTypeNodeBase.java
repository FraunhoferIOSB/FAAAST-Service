...
public abstract class AASMultiLanguagePropertyTypeNodeBase extends AASSubmodelElementTypeNode implements AASMultiLanguagePropertyType {
    private static GeneratedNodeInitializer<AASMultiLanguagePropertyTypeNode> aASMultiLanguagePropertyTypeNodeInitializer;

    protected AASMultiLanguagePropertyTypeNodeBase(NodeManagerUaNode nodeManager, NodeId nodeId,
    ...
    public void afterCreate() {
        ...
        GeneratedNodeInitializer<AASMultiLanguagePropertyTypeNode> impl = getAASMultiLanguagePropertyTypeNodeInitializer();
        if (impl != null) {
            impl.init((AASMultiLanguagePropertyTypeNode) this);
        }
    }


    public static GeneratedNodeInitializer<AASMultiLanguagePropertyTypeNode> getAASMultiLanguagePropertyTypeNodeInitializer() {
        return aASMultiLanguagePropertyTypeNodeInitializer;
    }


    public static void setAASMultiLanguagePropertyTypeNodeInitializer(GeneratedNodeInitializer<AASMultiLanguagePropertyTypeNode> aASMultiLanguagePropertyTypeNodeInitializerNewValue) {
        aASMultiLanguagePropertyTypeNodeInitializer = aASMultiLanguagePropertyTypeNodeInitializerNewValue;
    }
