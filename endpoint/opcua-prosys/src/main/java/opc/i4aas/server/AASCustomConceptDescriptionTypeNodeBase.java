 ...
 */
@TypeDefinitionId("nsu=http://opcfoundation.org/UA/I4AAS/V3/;i=1026")
public abstract class AASCustomConceptDescriptionTypeNodeBase extends DictionaryEntryTypeNode implements AASCustomConceptDescriptionType {
    private static GeneratedNodeInitializer<AASCustomConceptDescriptionTypeNode> aASCustomConceptDescriptionTypeNodeInitializer;

    protected AASCustomConceptDescriptionTypeNodeBase(NodeManagerUaNode nodeManager, NodeId nodeId,
    ...
    public void afterCreate() {
        ...
        GeneratedNodeInitializer<AASCustomConceptDescriptionTypeNode> impl = getAASCustomConceptDescriptionTypeNodeInitializer();
        if (impl != null) {
            impl.init((AASCustomConceptDescriptionTypeNode) this);
        }
    }


    public static GeneratedNodeInitializer<AASCustomConceptDescriptionTypeNode> getAASCustomConceptDescriptionTypeNodeInitializer() {
        return aASCustomConceptDescriptionTypeNodeInitializer;
    }


    public static void setAASCustomConceptDescriptionTypeNodeInitializer(GeneratedNodeInitializer<AASCustomConceptDescriptionTypeNode> aASCustomConceptDescriptionTypeNodeInitializerNewValue) {
        aASCustomConceptDescriptionTypeNodeInitializer = aASCustomConceptDescriptionTypeNodeInitializerNewValue;
    }
