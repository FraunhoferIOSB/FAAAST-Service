...
public class AASMultiLanguagePropertyTypeNode extends AASMultiLanguagePropertyTypeNodeBase {
    protected AASMultiLanguagePropertyTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId,
