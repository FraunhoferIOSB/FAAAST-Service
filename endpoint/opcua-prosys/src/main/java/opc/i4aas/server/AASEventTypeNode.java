...
public class AASEventTypeNode extends AASEventTypeNodeBase {
    protected AASEventTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName,
