...
public class AASIrdiConceptDescriptionTypeNode extends AASIrdiConceptDescriptionTypeNodeBase {
    protected AASIrdiConceptDescriptionTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId,
