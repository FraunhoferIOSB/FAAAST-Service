...
public class IAASIdentifiableTypeNode extends IAASIdentifiableTypeNodeBase {
    protected IAASIdentifiableTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId,
