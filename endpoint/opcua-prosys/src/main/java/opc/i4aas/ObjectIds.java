...
public interface ObjectIds {
    ...
    ExpandedNodeId AASDataSpecificationIEC61360Type_ValueList = ObjectIdsInit.initAASDataSpecificationIEC61360Type_ValueList();

    ExpandedNodeId AASIdentifierKeyValuePairType_ExternalSubjectId = ObjectIdsInit.initAASIdentifierKeyValuePairType_ExternalSubjectId();
    ...
    ExpandedNodeId AASMultiLanguagePropertyType_ValueId = ObjectIdsInit.initAASMultiLanguagePropertyType_ValueId();

    ExpandedNodeId AASPropertyType_ValueId = ObjectIdsInit.initAASPropertyType_ValueId();

    ExpandedNodeId AASReferenceElementType_Value = ObjectIdsInit.initAASReferenceElementType_Value();

    ExpandedNodeId AASRelationshipElementType_Second = ObjectIdsInit.initAASRelationshipElementType_Second();

    ExpandedNodeId AASRelationshipElementType_First = ObjectIdsInit.initAASRelationshipElementType_First();

    ExpandedNodeId AASAnnotatedRelationshipElementType_Annotation = ObjectIdsInit.initAASAnnotatedRelationshipElementType_Annotation();

    ExpandedNodeId AASSubmodelElementCollectionType_SubmodelElement_Qualifier = ObjectIdsInit.initAASSubmodelElementCollectionType_SubmodelElement_Qualifier();

    ExpandedNodeId AASSubmodelElementCollectionType_SubmodelElement_DataSpecification = ObjectIdsInit.initAASSubmodelElementCollectionType_SubmodelElement_DataSpecification();
    ...
    ExpandedNodeId AASIdentifierKeyValuePairList_AASIdentifierKeyValuePair = ObjectIdsInit.initAASIdentifierKeyValuePairList_AASIdentifierKeyValuePair();

    ExpandedNodeId AASQualifierList_AASQualifier = ObjectIdsInit.initAASQualifierList_AASQualifier();
