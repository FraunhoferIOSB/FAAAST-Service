...
public interface VariableIds {
    ...
    ExpandedNodeId AASCategoryDataType_EnumValues = VariableIdsInit.initAASCategoryDataType_EnumValues();

    ExpandedNodeId AASDataTypeIEC61360DataType_EnumStrings = VariableIdsInit.initAASDataTypeIEC61360DataType_EnumStrings();

    ExpandedNodeId AASEntityTypeDataType_EnumValues = VariableIdsInit.initAASEntityTypeDataType_EnumValues();

    ExpandedNodeId AASIdentifierTypeDataType_EnumValues = VariableIdsInit.initAASIdentifierTypeDataType_EnumValues();

    ExpandedNodeId AASKeyElementsDataType_EnumValues = VariableIdsInit.initAASKeyElementsDataType_EnumValues();

    ExpandedNodeId AASKeyTypeDataType_EnumValues = VariableIdsInit.initAASKeyTypeDataType_EnumValues();

    ExpandedNodeId AASLevelTypeDataType_EnumValues = VariableIdsInit.initAASLevelTypeDataType_EnumValues();

    ExpandedNodeId AASModelingKindDataType_EnumValues = VariableIdsInit.initAASModelingKindDataType_EnumValues();

    ExpandedNodeId AASValueTypeDataType_EnumStrings = VariableIdsInit.initAASValueTypeDataType_EnumStrings();

    ExpandedNodeId AASKeyDataType_DefaultXml_AASKeyDataType = VariableIdsInit.initAASKeyDataType_DefaultXml_AASKeyDataType();
    ...
    ExpandedNodeId AASAssetInformationType_DefaultThumbnail_MimeType = VariableIdsInit.initAASAssetInformationType_DefaultThumbnail_MimeType();
    ...
    ExpandedNodeId AASAssetInformationType_DefaultThumbnail_Category = VariableIdsInit.initAASAssetInformationType_DefaultThumbnail_Category();
    ...
    ExpandedNodeId AASSubmodelElementType_Category = VariableIdsInit.initAASSubmodelElementType_Category();
    ...
    ExpandedNodeId AASOrderedSubmodelElementCollectionType_SubmodelElement_Category = VariableIdsInit.initAASOrderedSubmodelElementCollectionType_SubmodelElement_Category();
    ...
    ExpandedNodeId AASReferenceType_Keys = VariableIdsInit.initAASReferenceType_Keys();
    ...
    ExpandedNodeId AASIriConceptDescriptionType_Identification_IdType = VariableIdsInit.initAASIriConceptDescriptionType_Identification_IdType();

    ExpandedNodeId AASIriConceptDescriptionType_Identification_Id = VariableIdsInit.initAASIriConceptDescriptionType_Identification_Id();
    ...
    ExpandedNodeId AASIdentifierKeyValuePairList_AASIdentifierKeyValuePair_Key = VariableIdsInit.initAASIdentifierKeyValuePairList_AASIdentifierKeyValuePair_Key();
    ...
    ExpandedNodeId AASIdentifierKeyValuePairList_AASIdentifierKeyValuePair_ExternalSubjectId_Keys = VariableIdsInit
            .initAASIdentifierKeyValuePairList_AASIdentifierKeyValuePair_ExternalSubjectId_Keys();

    ExpandedNodeId AASQualifierList_AASQualifier_ValueType = VariableIdsInit.initAASQualifierList_AASQualifier_ValueType();

    ExpandedNodeId AASQualifierList_AASQualifier_Type = VariableIdsInit.initAASQualifierList_AASQualifier_Type();

    ExpandedNodeId AASReferenceList_AASReference_Keys = VariableIdsInit.initAASReferenceList_AASReference_Keys();

    ExpandedNodeId AASSubmodelElementList_AASSubmodelElement_Category = VariableIdsInit.initAASSubmodelElementList_AASSubmodelElement_Category();

    ExpandedNodeId AASSubmodelElementList_AASSubmodelElement_ModelingKind = VariableIdsInit.initAASSubmodelElementList_AASSubmodelElement_ModelingKind();
}
