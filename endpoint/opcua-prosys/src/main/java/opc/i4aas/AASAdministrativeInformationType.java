...
public interface AASAdministrativeInformationType extends BaseObjectType {
    ...
    @Optional
    void setRevision(String value) throws StatusException;


    @Optional
    UaProperty getVersionNode();
    ...
    @Optional
    void setVersion(String value) throws StatusException;
}
