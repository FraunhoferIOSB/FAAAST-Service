...
public interface AASMultiLanguagePropertyType extends AASSubmodelElementType {
    String VALUE = "Value";
    ...
    @Optional
    LocalizedText[] getValue();


    @Optional
    void setValue(LocalizedText[] value) throws StatusException;
