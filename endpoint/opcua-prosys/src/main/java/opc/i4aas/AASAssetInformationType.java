...
public interface AASAssetInformationType extends BaseObjectType {
    ...
    String BILL_OF_MATERIAL = "BillOfMaterial";

    String DEFAULT_THUMBNAIL = "DefaultThumbnail";
    ...
    @Mandatory
    void setAssetKind(AASAssetKindDataType value) throws StatusException;


    @Mandatory
    AASReferenceList getBillOfMaterialNode();


    @Optional
    AASFileType getDefaultThumbnailNode();
    ...
    @Mandatory
    AASIdentifierKeyValuePairList getSpecificAssetIdNode();
}
