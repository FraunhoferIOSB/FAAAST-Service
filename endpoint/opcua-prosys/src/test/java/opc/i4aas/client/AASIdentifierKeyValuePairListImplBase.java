...
public abstract class AASIdentifierKeyValuePairListImplBase extends FolderTypeImpl implements AASIdentifierKeyValuePairList {
    protected AASIdentifierKeyValuePairListImplBase(AddressSpace addressSpace, NodeId nodeId,
