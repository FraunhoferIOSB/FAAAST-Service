...
public abstract class IAASReferableTypeImplBase extends BaseInterfaceTypeImpl implements IAASReferableType {
    protected IAASReferableTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
