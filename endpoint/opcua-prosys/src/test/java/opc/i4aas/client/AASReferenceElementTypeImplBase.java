...
public abstract class AASReferenceElementTypeImplBase extends AASSubmodelElementTypeImpl implements AASReferenceElementType {
    protected AASReferenceElementTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
    ...
    @Mandatory
    @Override
    public AASReferenceType getValueNode() {
