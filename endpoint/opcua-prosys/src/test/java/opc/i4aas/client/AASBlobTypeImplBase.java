...
public abstract class AASBlobTypeImplBase extends AASSubmodelElementTypeImpl implements AASBlobType {
    protected AASBlobTypeImplBase(AddressSpace addressSpace, NodeId nodeId, QualifiedName browseName,
