...
public abstract class AASQualifierTypeImplBase extends BaseObjectTypeImpl implements AASQualifierType {
    protected AASQualifierTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
