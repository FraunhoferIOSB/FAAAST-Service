...
public abstract class AASSubmodelElementListImplBase extends FolderTypeImpl implements AASSubmodelElementList {
    protected AASSubmodelElementListImplBase(AddressSpace addressSpace, NodeId nodeId,
