...
public class AASSimple {
    ...
    private static final String DOCUMENT_DEF = "Feste und geordnete Menge von fÃ¼r die Verwendung durch Personen bestimmte Informationen, die verwaltet und als Einheit zwischen Benutzern und System ausgetauscht werden kann.";
    ...
    private static final String MAX_ROTATE_DEF_DE = "HÃ¶chstezulÃ¤ssigeDrehzahl,mitwelcherderMotoroderdieSpeiseinheitbetriebenwerdendarf";
    ...
    private static final String DIGITAL_FILE_DEFINITION = "A file representing the document version. In addition to the mandatory PDF file, other files can be specified."; //"Eine Datei, die die Document Version reprÃ¤sentiert. Neben der obligatorischen PDF Datei kÃ¶nnen weitere Dateien angegeben werden.";
    ...
    private static final String SPRACHABHAENGIGER_TITELDES_DOKUMENTS = "SprachabhÃ¤ngigerTiteldesDokuments.";
    ...
    private static final String HTTPS_GITHUB_COM_ADMIN_SHELL_IO_BLOB_MASTER_VERWALTUNGSSCHALE_DETAIL_PART1_PNG = "./data/verwaltungsschale-detail-part1.png";
    ...
    private static final String SUBMODEL_DOCUMENTATION_FILE_VALUE = "./data/OPC-UA-Getting-Started.pdf";
        ...
        return new DefaultConceptDescription.Builder()
                ...
                .embeddedDataSpecification(new DefaultEmbeddedDataSpecification.Builder()
                        .dataSpecificationContent(new DefaultDataSpecificationIEC61360.Builder()
                                ...
                                .definition(new LangString(SPRACHABHAENGIGER_TITELDES_DOKUMENTS, "EN"))
                                .build())
                        .build())
                .build();
    }
    ...
    public static ConceptDescription createConceptDescriptionMaxRotationSpeed() {
        return new DefaultConceptDescription.Builder()
                ...
                .administration(new DefaultAdministrativeInformation.Builder()
                        ...
                        .build())
                .identification(new DefaultIdentifier.Builder()
                        .identifier(ID_0173_1_02_BAA120_008)
