...
/**
 * Configuration class for {@link DppEndpoint}.
 */
public class DppEndpointConfig extends EndpointConfig<DppEndpoint> {
    ...
    public boolean equals(Object o) {
        ...
        DppEndpointConfig that = (DppEndpointConfig) o;
    ...
    private abstract static class AbstractBuilder<T extends DppEndpointConfig, B extends AbstractBuilder<T, B>> extends EndpointConfig.AbstractBuilder<DppEndpoint, T, B> {
    ...
    public static class Builder extends AbstractBuilder<DppEndpointConfig, Builder> {
        ...
        @Override
        protected DppEndpointConfig newBuildingInstance() {
            return new DppEndpointConfig();
        }
    }
