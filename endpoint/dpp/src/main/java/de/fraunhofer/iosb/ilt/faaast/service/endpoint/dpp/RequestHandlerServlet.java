...
import de.fraunhofer.iosb.ilt.faaast.service.endpoint.dpp.request.RequestMappingManager;
import de.fraunhofer.iosb.ilt.faaast.service.endpoint.dpp.response.ResponseMappingManager;
...
public class RequestHandlerServlet extends HttpServlet {
    ...
    private final DppEndpoint endpoint;
    private final DppEndpointConfig config;
    ...
    public RequestHandlerServlet(DppEndpoint endpoint, DppEndpointConfig config, ServiceContext serviceContext) {
