...
/**
 * class to map HTTP-POST-Request path: query/submodels.
 */
public class QuerySubmodelsRequestMapper extends AbstractRequestMapper {

    private static final String PATTERN = "query/submodels";

    public QuerySubmodelsRequestMapper(ServiceContext serviceContext) {
