 ...
 */
public class PostConceptDescriptionResponseMapper extends AbstractResponseMapper<PostConceptDescriptionResponse> {
    ...
    @Override
    public void map(Request<PostConceptDescriptionResponse> apiRequest, PostConceptDescriptionResponse apiResponse, HttpServletResponse httpResponse) {
