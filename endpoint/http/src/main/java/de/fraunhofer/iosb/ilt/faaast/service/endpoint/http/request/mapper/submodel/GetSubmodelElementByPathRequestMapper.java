 ...
 */
public class GetSubmodelElementByPathRequestMapper extends AbstractSubmodelElementInterfaceRequestMapper<GetSubmodelElementByPathRequest, GetSubmodelElementByPathResponse> {

    public GetSubmodelElementByPathRequestMapper(ServiceContext serviceContext) {
        super(serviceContext, HttpMethod.GET, "", Content.REFERENCE);
    }
