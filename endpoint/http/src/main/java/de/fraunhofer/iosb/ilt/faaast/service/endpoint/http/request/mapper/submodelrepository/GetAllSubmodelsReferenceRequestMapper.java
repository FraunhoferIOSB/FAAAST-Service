...
/**
 * class to map HTTP-GET-Request path: submodels/$reference.
 */
public class GetAllSubmodelsReferenceRequestMapper extends AbstractRequestMapperWithOutputModifierAndPaging<GetAllSubmodelsReferenceRequest, GetAllSubmodelsReferenceResponse> {
    ...
    @Override
    public GetAllSubmodelsReferenceRequest doParse(HttpRequest httpRequest, Map<String, String> urlParameters, OutputModifier outputModifier, PagingInfo pagingInfo) {
        return GetAllSubmodelsReferenceRequest.builder().build();
    }
