 ...
 */
public class GetAllAssetAdministrationShellsReferenceRequestMapper
        extends AbstractRequestMapperWithOutputModifierAndPaging<GetAllAssetAdministrationShellsReferenceRequest, GetAllAssetAdministrationShellsReferenceResponse> {

    private static final String PATTERN = "shells/\\$reference";

    public GetAllAssetAdministrationShellsReferenceRequestMapper(ServiceContext serviceContext) {
    ...
    @Override
    public GetAllAssetAdministrationShellsReferenceRequest doParse(HttpRequest httpRequest, Map<String, String> urlParameters, OutputModifier outputModifier,
                                                                   PagingInfo pagingInfo) {
        return GetAllAssetAdministrationShellsReferenceRequest.builder().build();
    }
}
