...
/**
 * class to map HTTP-POST-Request path: query/concept-descriptions.
 */
public class QueryConceptDescriptionsRequestMapper extends AbstractRequestMapper {

    private static final String PATTERN = "query/concept-descriptions";

    public QueryConceptDescriptionsRequestMapper(ServiceContext serviceContext) {
    ...
    public Request doParse(HttpRequest httpRequest, Map<String, String> urlParameters) throws InvalidRequestException {
        ...
        QueryConceptDescriptionsRequest.Builder request = QueryConceptDescriptionsRequest.builder().query(new QueryParser().parse(query));
