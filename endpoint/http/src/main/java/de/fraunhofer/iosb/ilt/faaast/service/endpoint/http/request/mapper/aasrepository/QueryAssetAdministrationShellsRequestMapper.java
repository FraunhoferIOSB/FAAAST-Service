...
/**
 * class to map HTTP-POST-Request path: query/shells.
 */
public class QueryAssetAdministrationShellsRequestMapper extends AbstractRequestMapper {

    private static final String PATTERN = "query/shells";

    public QueryAssetAdministrationShellsRequestMapper(ServiceContext serviceContext) {
    ...
    public Request doParse(HttpRequest httpRequest, Map<String, String> urlParameters) throws InvalidRequestException {
        ...
        QueryAssetAdministrationShellsRequest.Builder request = QueryAssetAdministrationShellsRequest.builder()
