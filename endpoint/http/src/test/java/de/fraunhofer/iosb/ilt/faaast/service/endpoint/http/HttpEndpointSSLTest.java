...
public class HttpEndpointSSLTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(HttpEndpointSSLTest.class);
    ...
    private static String httpsSchemeString;
    ...
    public static void init() throws Exception {
        httpsSchemeString = HttpScheme.HTTPS.toString();
