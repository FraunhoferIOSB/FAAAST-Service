...
public class OpcUaEndpointFullTest {
    ...
    public static void startTest() throws Exception {
        ...
        outputArgs.add(new DefaultOperationVariable.Builder().value(new DefaultProperty.Builder().idShort("ExampleProperty2").valueType(DataTypeDefXsd.STRING).value("XYZ1").build())
                .build());
