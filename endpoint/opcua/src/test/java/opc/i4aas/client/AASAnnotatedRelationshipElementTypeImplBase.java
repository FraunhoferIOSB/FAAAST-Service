...
public abstract class AASAnnotatedRelationshipElementTypeImplBase extends AASRelationshipElementTypeImpl implements AASAnnotatedRelationshipElementType {
    protected AASAnnotatedRelationshipElementTypeImplBase(AddressSpace addressSpace, NodeId nodeId,
    ...
    @Mandatory
    @Override
    public AASSubmodelElementList getAnnotationNode() {
