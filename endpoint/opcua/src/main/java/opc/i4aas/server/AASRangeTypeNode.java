...
public class AASRangeTypeNode extends AASRangeTypeNodeBase {
    protected AASRangeTypeNode(NodeManagerUaNode nodeManager, NodeId nodeId, QualifiedName browseName,
