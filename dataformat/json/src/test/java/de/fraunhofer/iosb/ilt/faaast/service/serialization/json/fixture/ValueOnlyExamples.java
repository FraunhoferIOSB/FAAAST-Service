...
public class ValueOnlyExamples {
    ...
    public static final File INVOKE_OPERATION_REQUEST_2_FILE = new File(RESOURCE_PATH + "/invoke-operation-request-2.json");
    ...
    public static final InvokeOperationSyncRequest INVOKE_OPERATION_SYNC_REQUEST = InvokeOperationSyncRequest.builder()
            ...
            .inputArgument(new DefaultOperationVariable.Builder()
                    .value(new DefaultSubmodelElementCollection.Builder()
                            ...
                            .value(new DefaultProperty.Builder()
                                    .idShort("propertyString21")
                                    .valueType(DataTypeDefXsd.STRING)
                                    .value("foo")
                                    .build())
                            .value(new DefaultProperty.Builder()
                                    .idShort("propertyInt21")
                                    .valueType(DataTypeDefXsd.INT)
                                    .value("42")
                                    .build())
                            .value(new DefaultProperty.Builder()
                                    .idShort("propertyDouble21")
                                    .valueType(DataTypeDefXsd.DOUBLE)
                                    .value("42.17")
                                    .build())
                            .value(new DefaultSubmodelElementCollection.Builder()
                                    ...
                                    .value(new DefaultProperty.Builder()
                                            .idShort("propertyString31")
                                            .valueType(DataTypeDefXsd.STRING)
                                            .value("foo")
                                            .build())
                                    .value(new DefaultProperty.Builder()
                                            .idShort("propertyInt31")
                                            .valueType(DataTypeDefXsd.INT)
                                            .value("42")
                                            .build())
                                    .value(new DefaultProperty.Builder()
                                            .idShort("propertyDouble31")
                                            .valueType(DataTypeDefXsd.DOUBLE)
                                            .value("42.17")
                                            .build())
                                    .build())
    ...
    public static final InvokeOperationSyncRequest INVOKE_OPERATION_SYNC_REQUEST_2 = InvokeOperationSyncRequest.builder()
            .submodelId("http://example.org/submodels/1")
            .path("my.test.operation2")
            .timeout(DatatypeFactory.newDefaultInstance().newDuration("PT600S"))
            .inputArgument(new DefaultOperationVariable.Builder()
                    .value(new DefaultSubmodelElementCollection.Builder()
                            .idShort("data")
                            .value(new DefaultProperty.Builder()
