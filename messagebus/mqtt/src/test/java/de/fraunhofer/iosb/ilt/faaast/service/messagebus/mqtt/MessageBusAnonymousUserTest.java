...
public class MessageBusAnonymousUserTest {
    ...
    @Test
    public void testAnonymous() throws InterruptedException, MessageBusException, ConfigurationInitializationException {
        //this fails if the broker allows anonymous connections
        assertMessages(
