...
public class AASFullExample {

    public final AssetAdministrationShell AAS_1 = createAAS1();
    public final AssetAdministrationShell AAS_2 = createAAS2();
    public final AssetAdministrationShell AAS_3 = createAAS3();
    public final AssetAdministrationShell AAS_4 = createAAS4();
    public final Submodel SUBMODEL_1 = createSubmodel1();
    public final Submodel SUBMODEL_2 = createSubmodel2();
    public final Submodel SUBMODEL_3 = createSubmodel3();
    public final Submodel SUBMODEL_4 = createSubmodel4();
    public final Submodel SUBMODEL_5 = createSubmodel5();
    public final Submodel SUBMODEL_6 = createSubmodel6();
    public final Submodel SUBMODEL_7 = createSubmodel7();
    public final ConceptDescription CONCEPT_DESCRIPTION_1 = createConceptDescription1();
    public final ConceptDescription CONCEPT_DESCRIPTION_2 = createConceptDescription2();
    public final ConceptDescription CONCEPT_DESCRIPTION_3 = createConceptDescription3();
    public final ConceptDescription CONCEPT_DESCRIPTION_4 = createConceptDescription4();
    public final AssetAdministrationShellEnvironment ENVIRONMENT = createEnvironment();

    public AssetAdministrationShell createAAS1() {
    ...
    public AssetAdministrationShell createAAS2() {
        return new DefaultAssetAdministrationShell.Builder()
    ...
    public AssetAdministrationShell createAAS3() {
        return new DefaultAssetAdministrationShell.Builder()
    ...
    public AssetAdministrationShell createAAS4() {
        return new DefaultAssetAdministrationShell.Builder()
                .idShort("TestAssetAdministrationShell")
                .description(new LangString("An Example Asset Administration Shell for the test application", "en-us"))
                .description(new LangString("Ein Beispiel-Verwaltungsschale für eine Test-Anwendung", "de"))
    ...
    public Submodel createSubmodel1() {
    ...
    public Submodel createSubmodel2() {
        return new DefaultSubmodel.Builder()
    ...
    public Submodel createSubmodel3() {
        return new DefaultSubmodel.Builder()
    ...
    public Submodel createSubmodel4() {
        return new DefaultSubmodel.Builder()
    ...
    public Submodel createSubmodel5() {
        return new DefaultSubmodel.Builder()
    ...
    public Submodel createSubmodel6() {
        return new DefaultSubmodel.Builder()
                .idShort("TestSubmodel")
                .description(new LangString("An example submodel for the test application", "en-us"))
                .description(new LangString("Ein Beispiel-Teilmodell für eine Test-Anwendung", "de"))
    ...
    public Submodel createSubmodel7() {
        return new DefaultSubmodel.Builder()
                .idShort("TestSubmodel")
                .description(new LangString("An example submodel for the test application", "en-us"))
                .description(new LangString("Ein Beispiel-Teilmodell für eine Test-Anwendung", "de"))
    ...
    public ConceptDescription createConceptDescription1() {
    ...
    public ConceptDescription createConceptDescription2() {
        return new DefaultConceptDescription.Builder()
    ...
    public ConceptDescription createConceptDescription3() {
        return new DefaultConceptDescription.Builder()
    ...
    public ConceptDescription createConceptDescription4() {
        return new DefaultConceptDescription.Builder()
                .idShort("TestSpec_01")
                .identification(new DefaultIdentifier.Builder()
                        .idType(IdentifierType.IRI)
    ...
    public AssetAdministrationShellEnvironment createEnvironment() {
