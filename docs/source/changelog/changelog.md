...
*   General
	*   Unified way to configure certificate information ([See details](../../gettingstarted/configuration#providing-certificates-in-configuration)). Affected components: HTTP Asset Connection, OPC UA Asset Connection, HTTP Endpoint, MQTT MessageBus
