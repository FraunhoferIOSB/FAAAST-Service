...
| -------------------------------------------- | -------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| aasRegistries<br>*(optional)*                | List<String>   | URLs of AAS registries to use (optionally including /api/{version}). If not set, no synchronization of AASs with registry happens.            | *empty*                         |
...
| submodelRegistries<br>*(optional)*           | List<String>   | URLs of submodels registries to use (optionally including /api/{version}). If not set, no synchronization of submodels with registry happens. | *empty*                         |
