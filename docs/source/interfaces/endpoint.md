...
| pathPrefix<br>*(optional)*           | String                                                      | The path prefix to be used for automatic registration with registry. Must start with a "/" and not end with a "/". (regex: `^\/.*[^\/]$`; example: "/api/v3.0")                          |                                             |
