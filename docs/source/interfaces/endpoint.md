...
| subprotocolBody<br>*(optional)*         | String                                                      | The subprotocol body to be used for automatic registration with registry. Limited to a maximum of 128 characters.<br>Supports templating: any "{}" in the given subprotocolBody will be replaced with the AAS/submodel identifier.    |                                             |
