...
| 1 | - | {ref}`providing-certificates-in-configuration` |
| 2 | - | {ref}`#providing-certificates-in-configuration` |
| 3 | - | [See details](#providing-certificates-in-configuration) |
| 4 | - | (#providing-certificates-in-configuration) |

{ref}`providing-certificates-in-configuration`
{ref}`#providing-certificates-in-configuration`
