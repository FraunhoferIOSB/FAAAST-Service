...
/**
 * Class to handle a {@link de.fraunhofer.iosb.ilt.faaast.service.model.request.GetSubmodelRequest} in the service and
 * to send the corresponding response
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.response.GetSubmodelResponse}. Is responsible for
...
public class GetSubmodelRequestHandler extends AbstractSubmodelInterfaceRequestHandler<GetSubmodelRequest, GetSubmodelResponse> {
    ...
    public GetSubmodelResponse doProcess(GetSubmodelRequest request) throws ResourceNotFoundException, AssetConnectionException, ValueMappingException, MessageBusException {
        Submodel submodel = persistence.get(request.getSubmodelId(), request.getOutputModifier(), Submodel.class);
