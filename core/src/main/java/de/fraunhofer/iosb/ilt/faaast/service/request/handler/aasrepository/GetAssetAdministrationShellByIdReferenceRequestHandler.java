...
/**
 * Class to handle a
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.request.aasrepository.GetAssetAdministrationShellByIdReferenceRequest}
 * in the service and to send the corresponding response
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.response.aasrepository.GetAssetAdministrationShellByIdReferenceResponse}.
...
public class GetAssetAdministrationShellByIdReferenceRequestHandler
    ...
    @Override
    public GetAssetAdministrationShellByIdReferenceResponse process(GetAssetAdministrationShellByIdReferenceRequest request)
            throws ResourceNotFoundException, MessageBusException, StorageException {
