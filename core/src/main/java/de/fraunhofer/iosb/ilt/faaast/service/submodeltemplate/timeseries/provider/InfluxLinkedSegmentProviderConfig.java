...
/**
 * Configuration for {@link InfluxLinkedSegmentProvider}.
 */
public class InfluxLinkedSegmentProviderConfig extends LinkedSegmentProviderConfig<InfluxLinkedSegmentProvider> {
    ...
    protected abstract static class AbstractBuilder<C extends InfluxLinkedSegmentProviderConfig, B extends AbstractBuilder<C, B>>
    ...
    public static class Builder extends AbstractBuilder<InfluxLinkedSegmentProviderConfig, Builder> {
        ...
        @Override
        protected InfluxLinkedSegmentProviderConfig newBuildingInstance() {
            return new InfluxLinkedSegmentProviderConfig();
        }
    }
}
