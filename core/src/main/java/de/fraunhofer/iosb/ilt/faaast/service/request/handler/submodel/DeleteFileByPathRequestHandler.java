...
public class DeleteFileByPathRequestHandler extends AbstractSubmodelInterfaceRequestHandler<DeleteFileByPathRequest, DeleteFileByPathResponse> {
    ...
    public DeleteFileByPathRequestHandler(CoreConfig coreConfig, Persistence persistence, MessageBus messageBus, AssetConnectionManager assetConnectionManager) {
