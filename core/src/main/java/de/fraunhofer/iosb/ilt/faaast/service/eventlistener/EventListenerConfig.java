...
/**
 * Generic event listener configuration. When implementing a custom event listener inherit from this class to create a
 * custom configuration.
 *
 * @param <T> type of the event listener
 */
public abstract class EventListenerConfig<T extends EventListener> extends Config<T> {
     ...
     */
    public abstract static class AbstractBuilder<T extends EventListener, C extends EventListenerConfig<T>, B extends AbstractBuilder<T, C, B>> extends ExtendableBuilder<C, B> {
