...
public class GetAllSubmodelsByIdShortRequestHandler extends RequestHandler<GetAllSubmodelsByIdShortRequest, GetAllSubmodelsByIdShortResponse> {
    ...
    @Override
    public GetAllSubmodelsByIdShortResponse process(GetAllSubmodelsByIdShortRequest request) throws ResourceNotFoundException, AssetConnectionException, ValueMappingException {
