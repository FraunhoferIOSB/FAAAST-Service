...
/**
 * Class to handle a
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.request.DeleteAssetAdministrationShellByIdRequest} in the service
 * and to send the corresponding response
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.response.DeleteAssetAdministrationShellByIdResponse}. Is
...
public class DeleteAssetAdministrationShellByIdRequestHandler
    ...
    public DeleteAssetAdministrationShellByIdResponse process(DeleteAssetAdministrationShellByIdRequest request) throws ResourceNotFoundException, MessageBusException {
        ...
        AssetAdministrationShell shell = persistence.getOfType(request.getId(), new QueryModifier(), AssetAdministrationShell.class);
