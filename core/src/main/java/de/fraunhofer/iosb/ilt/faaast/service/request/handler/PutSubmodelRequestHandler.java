...
/**
 * Class to handle a
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.request.PutSubmodelRequest}
 * in the service and to send the corresponding response
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.response.PutSubmodelResponse}.
...
public class PutSubmodelRequestHandler extends RequestHandler<PutSubmodelRequest, PutSubmodelResponse> {
    ...
    @Override
    public PutSubmodelResponse process(PutSubmodelRequest request) throws ResourceNotFoundException, AssetConnectionException, ValueMappingException {
