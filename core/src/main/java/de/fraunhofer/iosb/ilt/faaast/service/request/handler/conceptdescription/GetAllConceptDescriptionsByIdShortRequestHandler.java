...
public class GetAllConceptDescriptionsByIdShortRequestHandler
    ...
    @Override
    public GetAllConceptDescriptionsByIdShortResponse process(GetAllConceptDescriptionsByIdShortRequest request) throws MessageBusException, StorageException {
