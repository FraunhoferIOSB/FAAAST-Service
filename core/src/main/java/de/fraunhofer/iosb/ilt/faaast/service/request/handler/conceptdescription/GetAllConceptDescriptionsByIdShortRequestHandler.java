...
public class GetAllConceptDescriptionsByIdShortRequestHandler
    ...
    public GetAllConceptDescriptionsByIdShortRequestHandler(CoreConfig coreConfig, Persistence persistence, MessageBus messageBus, AssetConnectionManager assetConnectionManager) {
