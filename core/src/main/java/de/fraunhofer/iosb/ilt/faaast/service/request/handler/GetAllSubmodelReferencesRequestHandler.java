...
/**
 * Class to handle a {@link de.fraunhofer.iosb.ilt.faaast.service.model.request.GetAllSubmodelReferencesRequest} in the
 * service and to send the corresponding response
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.response.GetAllSubmodelReferencesResponse}. Is responsible for
...
public class GetAllSubmodelReferencesRequestHandler extends AbstractRequestHandler<GetAllSubmodelReferencesRequest, GetAllSubmodelReferencesResponse> {
    ...
    public GetAllSubmodelReferencesRequestHandler(CoreConfig coreConfig, Persistence persistence, MessageBus messageBus, AssetConnectionManager assetConnectionManager) {
