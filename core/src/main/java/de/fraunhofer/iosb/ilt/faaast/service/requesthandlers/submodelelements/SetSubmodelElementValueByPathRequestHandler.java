...
import de.fraunhofer.iosb.ilt.faaast.service.model.v3.api.response.SetSubmodelElementValueByPathResponse;
...
public class SetSubmodelElementValueByPathRequestHandler extends RequestHandler<SetSubmodelElementValueByPathRequest<?>, SetSubmodelElementValueByPathResponse> {
    ...
    public SetSubmodelElementValueByPathResponse process(SetSubmodelElementValueByPathRequest request) {
        ...
        try {
            ...
            OutputModifier modifier = new OutputModifier();
            modifier.setExtend(Extend.WithBLOBValue);
            SubmodelElement submodelElement = persistence.get(reference, modifier);
