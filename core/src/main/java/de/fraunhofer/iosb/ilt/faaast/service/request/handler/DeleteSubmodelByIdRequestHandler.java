...
/**
 * Class to handle a {@link de.fraunhofer.iosb.ilt.faaast.service.model.request.DeleteSubmodelByIdRequest} in the
 * service and to send the corresponding response
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.response.DeleteSubmodelByIdResponse}. Is responsible for
...
public class DeleteSubmodelByIdRequestHandler extends AbstractRequestHandler<DeleteSubmodelByIdRequest, DeleteSubmodelByIdResponse> {
    ...
    public DeleteSubmodelByIdResponse process(DeleteSubmodelByIdRequest request) throws ResourceNotFoundException, MessageBusException {
        ...
        Submodel submodel = persistence.getOfType(request.getId(), new QueryModifier(), Submodel.class);
