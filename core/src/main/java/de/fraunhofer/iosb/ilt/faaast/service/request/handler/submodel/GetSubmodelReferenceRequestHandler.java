...
/**
 * Class to handle a
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.request.submodel.GetSubmodelReferenceRequest} in the service
 * and to send the corresponding response
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.response.submodel.GetSubmodelReferenceResponse}. Is
...
public class GetSubmodelReferenceRequestHandler extends AbstractSubmodelInterfaceRequestHandler<GetSubmodelReferenceRequest, GetSubmodelReferenceResponse> {
    ...
    public GetSubmodelReferenceResponse doProcess(GetSubmodelReferenceRequest request)
        ...
        return GetSubmodelReferenceResponse.builder()
                .payload(reference)
                .success()
                .build();
    }
