...
public class GetAllSubmodelElementsRequestHandler extends RequestHandler<GetAllSubmodelElementsRequest, GetAllSubmodelElementsResponse> {
    ...
    @Override
    public GetAllSubmodelElementsResponse process(GetAllSubmodelElementsRequest request) throws AssetConnectionException, ValueMappingException, ResourceNotFoundException {
