...
/**
 * Class to handle a
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.request.submodelrepository.GetSubmodelByIdRequest} in the
 * service
 * and to send the corresponding response
 * {@link de.fraunhofer.iosb.ilt.faaast.service.model.api.response.submodelrepository.GetSubmodelByIdResponse}. Is
 * responsible for
...
public class GetSubmodelByIdRequestHandler extends AbstractRequestHandler<GetSubmodelByIdRequest, GetSubmodelByIdResponse> {
    ...
    public GetSubmodelByIdRequestHandler(CoreConfig coreConfig, Persistence persistence, MessageBus messageBus, AssetConnectionManager assetConnectionManager) {
        super(coreConfig, persistence, messageBus, assetConnectionManager);
    }


    @Override
    public GetSubmodelByIdResponse process(GetSubmodelByIdRequest request)
        ...
        Submodel submodel = persistence.getSubmodel(request.getId(), request.getOutputModifier());
        ...
        messageBus.publish(ElementReadEventMessage.builder()
                ...
                .value(submodel)
                .build());
        return GetSubmodelByIdResponse.builder()
                .payload(submodel)
                .success()
                .build();
    }
