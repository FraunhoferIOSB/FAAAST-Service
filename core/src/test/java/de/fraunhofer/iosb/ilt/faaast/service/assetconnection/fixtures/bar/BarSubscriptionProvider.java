...
public class BarSubscriptionProvider implements AssetSubscriptionProvider {
    ...
    public void addNewDataListener(NewDataListener listener) throws AssetConnectionException {
        LOGGER.info("listener added for bar subscription provider");
    }


    @Override
    public void removeNewDataListener(NewDataListener listener) throws AssetConnectionException {
        LOGGER.info("listener removed for bar subscription provider");
    }


    @Override
    public void unsubscribe() throws AssetConnectionException {
        LOGGER.info("bar subscription provider unsubscribed");
    }


    @Override
    public BarSubscriptionProviderConfig asConfig() {
    ...
    public boolean equals(Object obj) {
        ...
        final BarSubscriptionProvider that = (BarSubscriptionProvider) obj;
